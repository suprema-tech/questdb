...
public abstract class AbstractFullPartitionFrameCursor implements PartitionFrameCursor {
    ...
    protected final PartitionDecoder parquetDecoder;
    ...
    protected AbstractFullPartitionFrameCursor(CairoConfiguration configuration) {
        this.parquetDecoder = new PartitionDecoder(configuration.getFilesFacade());
    }
